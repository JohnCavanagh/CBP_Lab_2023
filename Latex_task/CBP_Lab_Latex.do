...
cap file close f
file open f using "Final_Output.tex", write replace
...
file write f "Less than 5 thousand dollars: 2 \\" _n
file write f "Between 5 and 10 thousand dollars: 26 \\" _n
file write f "Over 10 thousand dollars: 3 \\" _n
